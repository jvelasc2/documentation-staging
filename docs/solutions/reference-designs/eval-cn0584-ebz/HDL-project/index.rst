...
:dokuwiki:`CN0584 Precision Low Latency Development Kit </resources/eval/user-guides/circuits-from-the-lab/cn0584>`
and :dokuwiki:`CN0585 Quad Channel, Low Latency, Data Acquisition and Signal Generation Module </resources/eval/user-guides/circuits-from-the-lab/cn0585>`.
...
be made by updating the :dokuwiki:`REG_CHAN_CNTRL_7 (DAC Channel) </resources/fpga/docs/hdl/regmap#:~:text=DAC%20Channel%20(axi_ad*)>`
register.
...
The :dokuwiki:`HDL user guide </resources/fpga/docs/hdl>` contains all the documentation, build instructions and register map tables.
