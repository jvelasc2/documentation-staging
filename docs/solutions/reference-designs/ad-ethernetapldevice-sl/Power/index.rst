...
specification. For the complete table, read the document's Table 6
of `Ethernet-APL Port Profile specification
<https://library.fieldcommgroup.org/10186/TS10186/1.1/#page=20>`_.
...
.. csv-table:: Line Voltage Threshold for sensed voltage between LINEA
    and LINEB (Excerpt only - incomplete table)
    :file: Line_thresolds.csv
...
.. csv-table:: Regulating Line Current during Shunt Regulation Mode
    (Excerpt only - incomplete table)
    :file: Regulation.csv
...
<https://ez.analog.com/>`_ community or contact your local ADI
representative.
