...
- :dokuwiki:`AXI_AD3552R IP core </resources/fpga/docs/axi_ad3552r>`
- :dokuwiki:`AXI_LTC2387 IP core </resources/fpga/docs/axi_ltc2387>`
...
- :git-pyadi-iio:`PyADI-IIO sources for the CN0585 Rev. B board <cn0585_v1>`
- :git-repo:`MATLAB and Simulink sources for the CN0585 Rev. B board </analogdevicesinc/HighSpeedConverterToolbox/tree/cn0585_v1>`
- :git-repo:`HDL Project sources for the CN0585 Rev. B board </analogdevicesinc/hdl/tree/cn0585_v1/projects/cn0585_fmcz>`
- :git-repo:`Linux driver sources for the CN0585 Rev. B board </analogdevicesinc/linux/tree/cn0585_v1>`
